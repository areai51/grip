            ...
            if operation == [] && !dragCancelledByEscape {
                ...
                if !endsInWindow {
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [Foundation.Notification.Name.gripSurfaceDragEndedNoTargetPointKey: screenPoint]
                    )
                }
            }
...
extension Notification.Name {
    ...
    static let gripSurfaceDragEndedNoTarget = Notification.Name("gripSurfaceDragEndedNoTarget")
    
    /// Key for the screen point where the drag ended in the userInfo dictionary.
    static let gripSurfaceDragEndedNoTargetPointKey = "endedAtPoint"
}
