...
extension Grip {
    /// Represents a single surface within Grip.
    ///
    /// NOTE(mitchellh): This is a work-in-progress class as part of a general refactor
    /// of our Grip data model. At the time of writing there's still a ton of surface
    ...
    final class Surface: Sendable {
        ...
        deinit {
            ...
            // calls into libgrip must happen there so we capture the surface
