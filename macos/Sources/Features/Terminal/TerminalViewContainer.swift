...
class TerminalViewContainer<ViewModel: TerminalViewModel>: NSView {
    ...
    init(grip: Grip.App, viewModel: ViewModel, delegate: (any TerminalViewDelegate)? = nil) {
        self.derivedConfig = DerivedConfig(config: grip.config)
...
private extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        var backgroundBlur: Grip.Config.BackgroundBlur
        var backgroundColor: Color = .clear

        init(config: Grip.Config) {
