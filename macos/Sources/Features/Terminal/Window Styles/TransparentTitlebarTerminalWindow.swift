...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: Grip.SurfaceView.DerivedConfig?
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: Grip.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: Grip.SurfaceView.DerivedConfig) {
