...
class TerminalWindow: NSWindow {
    ...
    /// added.
    static let tabBarIdentifier: NSUserInterfaceItemIdentifier = .init("_gripTabBar")
    ...
    func syncAppearance(_ surfaceConfig: Grip.SurfaceView.DerivedConfig) {
...
extension TerminalWindow {
    private static let closeTabsOnRightMenuItemIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.grip.closeTabsOnTheRightMenuItem")
    private static let changeTitleMenuItemIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.grip.changeTitleMenuItem")
    private static let tabColorSeparatorIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.grip.tabColorSeparator")

    private static let tabColorPaletteIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.grip.tabColorPalette")
