...
final class GripThemeTests: GripCustomConfigCase {
    let windowTitle = "GripThemeTests"
    ...
    /// https://github.com/grip-org/grip/issues/8282
    @MainActor
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of Grip are very slow and you may experience performance problems. Debug builds are only recommended during development."
